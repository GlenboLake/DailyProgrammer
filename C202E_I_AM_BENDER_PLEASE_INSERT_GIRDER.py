...
World, no one can hear his cries. Or in this case, understand them.
He talks in a sequence of on's and off's. 0's and 1's, it's binary. Obviously
as a mere human you can't possibly translate what he's saying as he says it.
...
'''
convert = lambda text: ''.join([chr(int(text[item:item + 8], 2)) for item in range(0, len(text), 8)])

print(convert('0100100001100101011011000110110001101111001000000101011101101111011100100110110001100100'))
print(convert('011100000110110001100101011000' +
              '010111001101100101001000000111' +
              '010001100001011011000110101100' +
              '100000011101000110111100100000' +
              '0110110101100101'))
print(convert('011011000110100101100110011001'+
